...
│   ├── explainability.js            # Tab 4 CFM cards + hover popover
...
| `explainability.js` | Tab 4. Renders nine CFM cards with confidence pills + top-coefficient bar charts + adaptive hover popovers (positions next to the hovered card with viewport collision detection). |
